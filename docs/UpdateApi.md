...
|------------- | ------------- | -------------|
| [**updateCatalogMetadata**](UpdateApi.md#updateCatalogMetadata) | **PATCH** /quakedb/table/v1/catalog-metadata/{id} | Update an existing catalog-metadata |
...
<a name="updateCatalogMetadata"></a>
# **updateCatalogMetadata**
> ObjectCatalogMetadata updateCatalogMetadata(id, objectCatalogMetadata)
...
public class Example {
  public static void main(String[] args) {
    ...
    Long id = 56L; // Long | INGV catalog-metadata id that need to be updated.
    ObjectCatalogMetadata objectCatalogMetadata = new ObjectCatalogMetadata(); // ObjectCatalogMetadata | JSON to update
    try {
      ObjectCatalogMetadata result = apiInstance.updateCatalogMetadata(id, objectCatalogMetadata);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UpdateApi#updateCatalogMetadata");
...
|------------- | ------------- | ------------- | -------------|
| **id** | **Long**| INGV catalog-metadata id that need to be updated. | |
| **objectCatalogMetadata** | [**ObjectCatalogMetadata**](ObjectCatalogMetadata.md)| JSON to update | |
