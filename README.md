...
- API version: 2.51.0-dev
  - Build date: 2022-09-12T10:16:57.649148Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.51.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.51.0-dev.jar`
* `target/lib/*.jar`
