...
Dante Web Services
- API version: 2.89.0-dev
  - Build date: 2023-03-30T16:14:22.957938Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.89.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.89.0-dev.jar`
* `target/lib/*.jar`
