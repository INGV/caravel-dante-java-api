...
Dante Web Services
- API version: 2.64.0-dev
  - Build date: 2022-12-07T17:39:37.662326Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.64.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.64.0-dev.jar`
* `target/lib/*.jar`
