...
Dante Web Services
- API version: 2.73.0
  - Build date: 2023-01-17T13:45:47.749852Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.73.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.73.0.jar`
* `target/lib/*.jar`
