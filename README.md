...
Dante Web Services
- API version: 2.87.0-dev
  - Build date: 2023-03-16T15:52:46.071303Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.87.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.87.0-dev.jar`
* `target/lib/*.jar`
