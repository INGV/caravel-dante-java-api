...
Dante Web Services
- API version: 3.21.0-dev
  - Build date: 2024-06-06T12:28:26.556240107Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.21.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.21.0-dev.jar`
* `target/lib/*.jar`
