...
Dante Web Services
- API version: 2.74.3
  - Build date: 2023-01-24T16:57:25.146494Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.74.3"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.74.3.jar`
* `target/lib/*.jar`
