...
Dante Web Services
- API version: 2.81.0-dev
  - Build date: 2023-02-26T10:07:16.085036Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.81.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.81.0-dev.jar`
* `target/lib/*.jar`
