...
Dante Web Services
- API version: 3.19.0-dev
  - Build date: 2024-05-24T07:27:05.513670360Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.19.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.19.0-dev.jar`
* `target/lib/*.jar`
