...
Dante Web Services
- API version: 3.6.0
  - Build date: 2024-01-19T19:29:21.614943Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.6.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.6.0.jar`
* `target/lib/*.jar`
