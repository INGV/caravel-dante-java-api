...
Dante Web Services
- API version: 2.73.0-dev
  - Build date: 2023-01-17T12:10:25.692141Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.73.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.73.0-dev.jar`
* `target/lib/*.jar`
