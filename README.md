...
Dante Web Services
- API version: 2.50.0-dev
  - Build date: 2022-09-09T08:08:08.409457Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.50.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.50.0-dev.jar`
* `target/lib/*.jar`
