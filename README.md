...
Dante Web Services
- API version: 2.92.0-dev
  - Build date: 2023-05-02T14:46:38.869704Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.92.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.92.0-dev.jar`
* `target/lib/*.jar`
