...
Dante Web Services
- API version: 2.61.0
  - Build date: 2022-11-28T16:53:47.506881Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.61.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.61.0.jar`
* `target/lib/*.jar`
