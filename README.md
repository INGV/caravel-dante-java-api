...
Dante Web Services
- API version: 3.1.0
  - Build date: 2023-12-05T08:49:09.422242Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.1.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.1.0.jar`
* `target/lib/*.jar`
