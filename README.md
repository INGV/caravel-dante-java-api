...
Dante Web Services
- API version: 2.66.0-dev
  - Build date: 2022-12-22T08:42:25.347673Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.66.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.66.0-dev.jar`
* `target/lib/*.jar`
