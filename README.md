...
- API version: 3.23.0-dev
  - Build date: 2024-07-01T12:54:19.180363713Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.23.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.23.0-dev.jar`
* `target/lib/*.jar`
