...
Dante Web Services
- API version: 2.77.2
  - Build date: 2023-02-08T10:36:52.249464Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.77.2"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.77.2.jar`
* `target/lib/*.jar`
