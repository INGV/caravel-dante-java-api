...
Dante Web Services
- API version: 2.85.0-dev
  - Build date: 2023-03-15T15:06:24.852289Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.85.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.85.0-dev.jar`
* `target/lib/*.jar`
