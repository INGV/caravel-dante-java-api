...
Dante Web Services
- API version: 2.55.0-dev
  - Build date: 2022-09-20T16:38:37.895050Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.55.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.55.0-dev.jar`
* `target/lib/*.jar`
