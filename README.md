...
Dante Web Services
- API version: 2.77.0
  - Build date: 2023-02-01T12:57:44.636192Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.77.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.77.0.jar`
* `target/lib/*.jar`
