...
Dante Web Services
- API version: 2.77.1
  - Build date: 2023-02-01T15:10:57.056343Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.77.1"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.77.1.jar`
* `target/lib/*.jar`
