...
Dante Web Services
- API version: 2.88.0-dev
  - Build date: 2023-03-28T13:27:20.058177Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.88.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.88.0-dev.jar`
* `target/lib/*.jar`
