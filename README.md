...
Dante Web Services
- API version: 3.28.0
  - Build date: 2024-12-17T10:18:34.078355344Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.28.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.28.0.jar`
* `target/lib/*.jar`
