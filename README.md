...
Dante Web Services
- API version: 2.76.0
  - Build date: 2023-01-27T09:30:12.840304Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.76.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.76.0.jar`
* `target/lib/*.jar`
