...
Dante Web Services
- API version: 2.53.0
  - Build date: 2022-09-20T14:34:30.159845Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.53.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.53.0.jar`
* `target/lib/*.jar`
