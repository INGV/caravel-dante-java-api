...
Dante Web Services
- API version: 3.2.0
  - Build date: 2023-12-14T19:02:16.873525Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.2.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.2.0.jar`
* `target/lib/*.jar`
