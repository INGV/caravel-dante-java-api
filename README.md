...
Dante Web Services
- API version: 2.88.0
  - Build date: 2023-03-30T16:17:44.674576Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.88.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.88.0.jar`
* `target/lib/*.jar`
