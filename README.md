...
Dante Web Services
- API version: 2.82.0-dev
  - Build date: 2023-02-26T11:38:33.090981Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.82.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.82.0-dev.jar`
* `target/lib/*.jar`
