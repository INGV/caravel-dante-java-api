...
Dante Web Services
- API version: 2.61.1
  - Build date: 2022-11-29T11:20:47.297075Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.61.1"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.61.1.jar`
* `target/lib/*.jar`
