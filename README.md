...
Dante Web Services
- API version: 2.52.0-dev
  - Build date: 2022-09-15T19:11:50.388149Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.52.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.52.0-dev.jar`
* `target/lib/*.jar`
