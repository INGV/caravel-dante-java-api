...
Dante Web Services
- API version: 3.5.0-dev
  - Build date: 2024-01-03T10:45:53.484216Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.5.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.5.0-dev.jar`
* `target/lib/*.jar`
