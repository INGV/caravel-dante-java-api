...
Dante Web Services
- API version: 2.85.0
  - Build date: 2023-03-15T16:07:04.045716Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.85.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.85.0.jar`
* `target/lib/*.jar`
