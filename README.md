...
Dante Web Services
- API version: 2.63.0-dev
  - Build date: 2022-12-07T15:08:14.139975Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.63.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.63.0-dev.jar`
* `target/lib/*.jar`
