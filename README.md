...
Dante Web Services
- API version: 2.53.0-dev
  - Build date: 2022-09-19T14:02:37.485327Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.53.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.53.0-dev.jar`
* `target/lib/*.jar`
