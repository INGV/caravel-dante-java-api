...
Dante Web Services
- API version: 3.14.0-dev
  - Build date: 2024-02-23T11:18:19.413645159Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.14.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.14.0-dev.jar`
* `target/lib/*.jar`
