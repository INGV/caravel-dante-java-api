...
- API version: 3.3.0-dev
  - Build date: 2023-12-28T14:31:02.099487Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.3.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.3.0-dev.jar`
* `target/lib/*.jar`
