...
Dante Web Services
- API version: 2.97.0
  - Build date: 2023-09-20T16:43:01.812904Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.97.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.97.0.jar`
* `target/lib/*.jar`
