...
Dante Web Services
- API version: 2.56.0
  - Build date: 2022-10-03T09:57:11.859303Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.56.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.56.0.jar`
* `target/lib/*.jar`
