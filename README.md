...
Dante Web Services
- API version: 2.72.0
  - Build date: 2023-01-16T15:18:02.413487Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.72.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.72.0.jar`
* `target/lib/*.jar`
