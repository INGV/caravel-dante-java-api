...
Dante Web Services
- API version: 2.87.1
  - Build date: 2023-03-23T09:59:01.261552Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.87.1"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.87.1.jar`
* `target/lib/*.jar`
