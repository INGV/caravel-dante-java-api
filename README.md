...
Dante Web Services
- API version: 2.91.0-dev
  - Build date: 2023-04-28T14:40:46.861433Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.91.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.91.0-dev.jar`
* `target/lib/*.jar`
