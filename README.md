...
Dante Web Services
- API version: 2.63.0
  - Build date: 2022-12-12T10:55:32.830476Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.63.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.63.0.jar`
* `target/lib/*.jar`
