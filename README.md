...
Dante Web Services
- API version: 2.96.4
  - Build date: 2023-09-08T11:10:55.973024Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.96.4"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.96.4.jar`
* `target/lib/*.jar`
