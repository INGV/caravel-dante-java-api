...
Dante Web Services
- API version: 2.55.0
  - Build date: 2022-09-26T10:13:43.649377Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.55.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.55.0.jar`
* `target/lib/*.jar`
