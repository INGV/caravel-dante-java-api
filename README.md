...
- API version: 2.96.0-dev
  - Build date: 2023-07-17T15:03:35.464449Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.96.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.96.0-dev.jar`
* `target/lib/*.jar`
