...
Dante Web Services
- API version: 3.26.0-dev
  - Build date: 2024-11-19T14:41:04.223541444Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.26.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.26.0-dev.jar`
* `target/lib/*.jar`
