...
Dante Web Services
- API version: 3.9.0-dev
  - Build date: 2024-01-22T21:20:11.868860Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.9.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.9.0-dev.jar`
* `target/lib/*.jar`
