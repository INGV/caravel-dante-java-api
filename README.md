...
- API version: 2.59.0-dev
  - Build date: 2022-10-11T13:34:27.522857Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.59.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.59.0-dev.jar`
* `target/lib/*.jar`
