...
Dante Web Services
- API version: 2.61.0-dev
  - Build date: 2022-10-24T11:55:06.575997Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.61.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.61.0-dev.jar`
* `target/lib/*.jar`
