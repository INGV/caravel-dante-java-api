...
Dante Web Services
- API version: 2.78.1
  - Build date: 2023-02-21T14:35:31.572962Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.78.1"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.78.1.jar`
* `target/lib/*.jar`
