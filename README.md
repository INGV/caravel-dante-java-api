...
- API version: 2.83.0-dev
  - Build date: 2023-03-09T06:59:32.131734Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.83.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.83.0-dev.jar`
* `target/lib/*.jar`
