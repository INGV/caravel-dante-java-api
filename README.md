...
Dante Web Services
- API version: 3.11.0
  - Build date: 2024-02-13T16:30:30.061605Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.11.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.11.0.jar`
* `target/lib/*.jar`
