...
- API version: 2.68.0-dev
  - Build date: 2023-01-04T13:09:33.783856Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.68.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.68.0-dev.jar`
* `target/lib/*.jar`
