...
Dante Web Services
- API version: 3.8.2
  - Build date: 2024-01-22T16:45:36.722624Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.8.2"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.8.2.jar`
* `target/lib/*.jar`
