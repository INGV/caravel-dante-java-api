...
Dante Web Services
- API version: 2.79.0-dev
  - Build date: 2023-02-21T12:15:20.233141Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.79.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.79.0-dev.jar`
* `target/lib/*.jar`
