...
Dante Web Services
- API version: 2.60.0
  - Build date: 2022-10-19T10:34:47.376859Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.60.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.60.0.jar`
* `target/lib/*.jar`
