...
Dante Web Services
- API version: 3.27.0-dev
  - Build date: 2024-11-19T16:30:34.931311548Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.27.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.27.0-dev.jar`
* `target/lib/*.jar`
...
## Documentation for Models
 ...
 - [ObjectTypeOriginForVw](docs/ObjectTypeOriginForVw.md)
