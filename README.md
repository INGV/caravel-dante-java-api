...
- API version: 3.10.0-dev
  - Build date: 2024-01-23T10:14:27.350732Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.10.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.10.0-dev.jar`
* `target/lib/*.jar`
