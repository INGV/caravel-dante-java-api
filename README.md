...
Dante Web Services
- API version: 3.0.1
  - Build date: 2023-11-27T17:56:53.026778Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.0.1"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.0.1.jar`
* `target/lib/*.jar`
