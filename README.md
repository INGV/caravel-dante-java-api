...
Dante Web Services
- API version: 2.79.0
  - Build date: 2023-02-24T16:41:36.785741Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.79.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.79.0.jar`
* `target/lib/*.jar`
