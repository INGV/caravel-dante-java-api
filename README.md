...
Dante Web Services
- API version: 2.92.0
  - Build date: 2023-05-09T09:07:26.884267Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.92.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.92.0.jar`
* `target/lib/*.jar`
