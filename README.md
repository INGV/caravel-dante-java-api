...
Dante Web Services
- API version: 3.7.0-dev
  - Build date: 2024-01-18T07:51:33.231880Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.7.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.7.0-dev.jar`
* `target/lib/*.jar`
