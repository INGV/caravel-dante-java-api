...
- API version: 2.49.0-dev
  - Build date: 2022-08-08T09:24:39.779299Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.49.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.49.0-dev.jar`
* `target/lib/*.jar`
