...
Dante Web Services
- API version: 2.72.2
  - Build date: 2023-01-17T07:51:59.359040Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.72.2"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.72.2.jar`
* `target/lib/*.jar`
