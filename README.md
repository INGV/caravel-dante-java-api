...
Dante Web Services
- API version: 2.93.0
  - Build date: 2023-05-29T15:40:10.926291Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.93.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.93.0.jar`
* `target/lib/*.jar`
