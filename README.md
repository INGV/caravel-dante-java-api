...
Dante Web Services
- API version: 3.27.1
  - Build date: 2024-11-22T11:25:42.634137839Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.27.1"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.27.1.jar`
* `target/lib/*.jar`
