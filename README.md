...
Dante Web Services
- API version: 2.62.0-dev
  - Build date: 2022-11-29T10:59:10.793163Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.62.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.62.0-dev.jar`
* `target/lib/*.jar`
