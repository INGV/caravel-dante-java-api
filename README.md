...
- API version: 3.6.0-dev
  - Build date: 2024-01-10T16:14:07.877840Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.6.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.6.0-dev.jar`
* `target/lib/*.jar`
