...
Dante Web Services
- API version: 2.91.1
  - Build date: 2023-05-02T15:05:32.069603Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.91.1"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.91.1.jar`
* `target/lib/*.jar`
