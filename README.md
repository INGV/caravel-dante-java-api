...
Dante Web Services
- API version: 2.56.0-dev
  - Build date: 2022-09-26T10:12:06.818404Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.56.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.56.0-dev.jar`
* `target/lib/*.jar`
