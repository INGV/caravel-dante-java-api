...
Dante Web Services
- API version: 2.48.0-dev
  - Build date: 2022-07-06T12:49:35.509886Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.48.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.48.0-dev.jar`
* `target/lib/*.jar`
