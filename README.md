...
- API version: 2.46.0-dev
  - Build date: 2022-06-20T17:37:07.544727Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.46.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.46.0-dev.jar`
* `target/lib/*.jar`
