...
Dante Web Services
- API version: 3.3.0
  - Build date: 2024-01-02T17:59:16.300581Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.3.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.3.0.jar`
* `target/lib/*.jar`
