...
Dante Web Services
- API version: 2.47.0-dev
  - Build date: 2022-07-04T17:17:21.832319Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.47.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.47.0-dev.jar`
* `target/lib/*.jar`
