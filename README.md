...
Dante Web Services
- API version: 3.25.0-dev
  - Build date: 2024-09-26T15:15:24.932312978Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.25.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.25.0-dev.jar`
* `target/lib/*.jar`
