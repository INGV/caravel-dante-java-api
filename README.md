...
Dante Web Services
- API version: 2.90.0-dev
  - Build date: 2023-04-12T08:41:46.813516Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.90.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.90.0-dev.jar`
* `target/lib/*.jar`
