...
Dante Web Services
- API version: 2.89.0
  - Build date: 2023-03-31T10:33:58.421289Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.89.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.89.0.jar`
* `target/lib/*.jar`
