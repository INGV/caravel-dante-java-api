...
- API version: 3.28.0-dev
  - Build date: 2024-12-16T21:18:36.646078951Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.28.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.28.0-dev.jar`
* `target/lib/*.jar`
