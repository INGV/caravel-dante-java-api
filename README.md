...
Dante Web Services
- API version: 2.54.0
  - Build date: 2022-09-20T17:21:02.308373Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.54.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.54.0.jar`
* `target/lib/*.jar`
