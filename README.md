...
Dante Web Services
- API version: 2.75.0
  - Build date: 2023-01-26T08:31:13.376270Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.75.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.75.0.jar`
* `target/lib/*.jar`
