...
Dante Web Services
- API version: 2.94.0
  - Build date: 2023-07-13T16:11:46.693494Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.94.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.94.0.jar`
* `target/lib/*.jar`
