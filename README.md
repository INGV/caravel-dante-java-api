...
Dante Web Services
- API version: 2.60.2
  - Build date: 2022-11-22T13:31:59.117112Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.60.2"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.60.2.jar`
* `target/lib/*.jar`
