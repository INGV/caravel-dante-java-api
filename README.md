...
Dante Web Services
- API version: 3.29.0-dev
  - Build date: 2024-12-17T10:23:21.743676796Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.29.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.29.0-dev.jar`
* `target/lib/*.jar`
