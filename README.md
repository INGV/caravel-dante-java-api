...
Dante Web Services
- API version: 2.78.0-dev
  - Build date: 2023-02-03T09:34:17.726881Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.78.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.78.0-dev.jar`
* `target/lib/*.jar`
