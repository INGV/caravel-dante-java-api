...
Dante Web Services
- API version: 2.72.0-dev
  - Build date: 2023-01-16T11:57:22.361030Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.72.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.72.0-dev.jar`
* `target/lib/*.jar`
