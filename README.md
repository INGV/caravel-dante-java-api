...
Dante Web Services
- API version: 3.12.0
  - Build date: 2024-02-20T11:41:53.252151237Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.12.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.12.0.jar`
* `target/lib/*.jar`
