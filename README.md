...
Dante Web Services
- API version: 2.96.3
  - Build date: 2023-08-30T14:11:14.318677Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.96.3"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.96.3.jar`
* `target/lib/*.jar`
