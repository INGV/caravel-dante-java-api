...
Dante Web Services
- API version: 2.98.0
  - Build date: 2023-09-27T14:16:36.793070Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.98.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.98.0.jar`
* `target/lib/*.jar`
