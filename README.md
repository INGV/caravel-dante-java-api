...
Dante Web Services
- API version: 2.62.0
  - Build date: 2022-12-07T15:09:07.364871Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.62.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.62.0.jar`
* `target/lib/*.jar`
