...
Dante Web Services
- API version: 3.17.0
  - Build date: 2024-05-23T13:34:54.847912476Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.17.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.17.0.jar`
* `target/lib/*.jar`
