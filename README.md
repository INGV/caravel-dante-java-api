...
Dante Web Services
- API version: 2.94.0-dev
  - Build date: 2023-05-23T08:15:00.349923Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.94.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.94.0-dev.jar`
* `target/lib/*.jar`
