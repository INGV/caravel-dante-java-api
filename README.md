...
Dante Web Services
- API version: 3.13.0-dev
  - Build date: 2024-02-20T11:40:04.372601091Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.13.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.13.0-dev.jar`
* `target/lib/*.jar`
