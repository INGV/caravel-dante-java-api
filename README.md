...
Dante Web Services
- API version: 2.57.0
  - Build date: 2022-10-04T13:12:08.435603Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.57.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.57.0.jar`
* `target/lib/*.jar`
