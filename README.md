...
Dante Web Services
- API version: 3.25.0
  - Build date: 2024-10-29T12:14:11.282354625Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.25.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.25.0.jar`
* `target/lib/*.jar`
