...
Dante Web Services
- API version: 2.93.0-dev
  - Build date: 2023-05-09T07:12:17.546541Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.93.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.93.0-dev.jar`
* `target/lib/*.jar`
