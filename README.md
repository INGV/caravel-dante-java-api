...
Dante Web Services
- API version: 2.77.0-dev
  - Build date: 2023-02-01T11:55:54.868515Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.77.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.77.0-dev.jar`
* `target/lib/*.jar`
