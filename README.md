...
Dante Web Services
- API version: 3.8.0-dev
  - Build date: 2024-01-22T07:59:48.100432Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.8.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.8.0-dev.jar`
* `target/lib/*.jar`
