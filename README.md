...
Dante Web Services
- API version: 3.24.0
  - Build date: 2024-09-19T14:32:21.498550363Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.24.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.24.0.jar`
* `target/lib/*.jar`
