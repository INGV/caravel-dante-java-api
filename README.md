...
Dante Web Services
- API version: 3.4.0-dev
  - Build date: 2024-01-02T17:58:05.846055Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.4.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.4.0-dev.jar`
* `target/lib/*.jar`
