...
Dante Web Services
- API version: 2.78.2
  - Build date: 2023-02-21T15:12:30.464151Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.78.2"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.78.2.jar`
* `target/lib/*.jar`
