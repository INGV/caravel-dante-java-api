...
Dante Web Services
- API version: 3.24.0-dev
  - Build date: 2024-09-18T10:55:36.178951892Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.24.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.24.0-dev.jar`
* `target/lib/*.jar`
