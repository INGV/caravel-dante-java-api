...
- API version: 2.60.0-dev
  - Build date: 2022-10-14T14:46:47.250116Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.60.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.60.0-dev.jar`
* `target/lib/*.jar`
