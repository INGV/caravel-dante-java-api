...
Dante Web Services
- API version: 2.76.0-dev
  - Build date: 2023-01-26T08:41:29.334340Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.76.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.76.0-dev.jar`
* `target/lib/*.jar`
