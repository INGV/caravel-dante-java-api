...
Dante Web Services
- API version: 2.86.0-dev
  - Build date: 2023-03-16T09:08:10.741073Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.86.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.86.0-dev.jar`
* `target/lib/*.jar`
