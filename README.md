...
Dante Web Services
- API version: 2.99.0
  - Build date: 2023-09-28T12:07:56.685868Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.99.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.99.0.jar`
* `target/lib/*.jar`
