...
Dante Web Services
- API version: 2.67.0-dev
  - Build date: 2023-01-04T11:23:47.899840Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.67.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.67.0-dev.jar`
* `target/lib/*.jar`
