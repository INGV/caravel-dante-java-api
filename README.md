...
- API version: 3.0.0-dev
  - Build date: 2023-09-28T12:05:53.828421Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.0.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.0.0-dev.jar`
* `target/lib/*.jar`
