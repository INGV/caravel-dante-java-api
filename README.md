...
Dante Web Services
- API version: 2.80.0-dev
  - Build date: 2023-02-24T16:22:27.107852Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.80.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.80.0-dev.jar`
* `target/lib/*.jar`
