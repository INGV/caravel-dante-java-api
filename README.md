...
Dante Web Services
- API version: 2.54.0-dev
  - Build date: 2022-09-20T14:54:50.432277Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.54.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.54.0-dev.jar`
* `target/lib/*.jar`
