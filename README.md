...
Dante Web Services
- API version: 2.46.0
  - Build date: 2022-06-24T15:19:29.581436Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.46.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.46.0.jar`
* `target/lib/*.jar`
