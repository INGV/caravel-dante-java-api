...
- API version: 3.12.0-dev
  - Build date: 2024-02-14T08:31:04.853374Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.12.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.12.0-dev.jar`
* `target/lib/*.jar`
