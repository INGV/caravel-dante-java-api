...
Dante Web Services
- API version: 2.98.0-dev
  - Build date: 2023-09-20T16:40:04.026713Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.98.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.98.0-dev.jar`
* `target/lib/*.jar`
