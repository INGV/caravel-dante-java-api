...
Dante Web Services
- API version: 2.86.0
  - Build date: 2023-03-22T16:41:07.766442Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.86.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.86.0.jar`
* `target/lib/*.jar`
