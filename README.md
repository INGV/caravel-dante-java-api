...
Dante Web Services
- API version: 2.71.6
  - Build date: 2023-01-16T12:27:46.679440Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.71.6"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.71.6.jar`
* `target/lib/*.jar`
