...
Dante Web Services
- API version: 3.18.0-dev
  - Build date: 2024-05-22T15:44:38.506478671Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.18.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.18.0-dev.jar`
* `target/lib/*.jar`
