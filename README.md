...
Dante Web Services
- API version: 2.57.0-dev
  - Build date: 2022-10-04T08:09:19.592130Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.57.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.57.0-dev.jar`
* `target/lib/*.jar`
