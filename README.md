...
- API version: 2.65.0-dev
  - Build date: 2022-12-15T09:36:49.542020Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.65.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.65.0-dev.jar`
* `target/lib/*.jar`
