...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.40.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.40.0-dev.jar`
* `target/lib/*.jar`
