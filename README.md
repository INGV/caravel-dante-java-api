...
Dante Web Services
- API version: 2.75.0-dev
  - Build date: 2023-01-20T16:46:34.151104Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.75.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.75.0-dev.jar`
* `target/lib/*.jar`
