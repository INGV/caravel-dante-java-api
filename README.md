...
Dante Web Services
- API version: 2.49.0
  - Build date: 2022-09-06T10:03:35.151930Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.49.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.49.0.jar`
* `target/lib/*.jar`
