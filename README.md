...
Dante Web Services
- API version: 2.99.0-dev
  - Build date: 2023-09-28T11:11:22.590390Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.99.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.99.0-dev.jar`
* `target/lib/*.jar`
