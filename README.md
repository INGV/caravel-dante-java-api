...
Dante Web Services
- API version: 2.95.0-dev
  - Build date: 2023-06-15T19:17:39.498240Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.95.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.95.0-dev.jar`
* `target/lib/*.jar`
