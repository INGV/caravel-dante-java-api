...
Dante Web Services
- API version: 3.11.0-dev
  - Build date: 2024-02-08T20:11:21.482819Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.11.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.11.0-dev.jar`
* `target/lib/*.jar`
