...
Dante Web Services
- API version: 2.48.1
  - Build date: 2022-08-01T09:25:56.214307Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.48.1"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.48.1.jar`
* `target/lib/*.jar`
