...
- API version: 3.20.0-dev
  - Build date: 2024-05-24T11:39:22.302942815Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:3.20.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-3.20.0-dev.jar`
* `target/lib/*.jar`
