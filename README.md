...
Dante Web Services
- API version: 2.61.2
  - Build date: 2022-11-29T18:04:21.938448Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.61.2"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.61.2.jar`
* `target/lib/*.jar`
