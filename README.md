...
Dante Web Services
- API version: 2.58.0-dev
  - Build date: 2022-10-04T13:11:17.335193Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.58.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.58.0-dev.jar`
* `target/lib/*.jar`
