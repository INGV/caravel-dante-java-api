...
Dante Web Services
- API version: 2.78.0
  - Build date: 2023-02-21T13:55:53.376859Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.78.0"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.78.0.jar`
* `target/lib/*.jar`
