...
Dante Web Services
- API version: 2.97.0-dev
  - Build date: 2023-09-07T20:38:20.378659Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "org.ingv.dante:java-openapi-generator-cli-dante:2.97.0-dev"
  }
```
...
* `target/java-openapi-generator-cli-dante-2.97.0-dev.jar`
* `target/lib/*.jar`
