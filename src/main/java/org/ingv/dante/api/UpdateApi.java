...
public class UpdateApi {
    ...
    /**
     * Build call for updateCatalogMetadata
     * @param id INGV catalog-metadata id that need to be updated. (required)
     * @param objectCatalogMetadata JSON to update (required)
     ...
     */
    public okhttp3.Call updateCatalogMetadataCall(Long id, ObjectCatalogMetadata objectCatalogMetadata, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/quakedb/table/v1/catalog-metadata/{id}"
    ...
    private okhttp3.Call updateCatalogMetadataValidateBeforeCall(Long id, ObjectCatalogMetadata objectCatalogMetadata, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateCatalogMetadata(Async)");
        }
        
        // verify the required parameter 'objectCatalogMetadata' is set
        if (objectCatalogMetadata == null) {
            throw new ApiException("Missing the required parameter 'objectCatalogMetadata' when calling updateCatalogMetadata(Async)");
        }
        

        okhttp3.Call localVarCall = updateCatalogMetadataCall(id, objectCatalogMetadata, _callback);
        return localVarCall;
     ...
     */
    public ObjectCatalogMetadata updateCatalogMetadata(Long id, ObjectCatalogMetadata objectCatalogMetadata) throws ApiException {
        ApiResponse<ObjectCatalogMetadata> localVarResp = updateCatalogMetadataWithHttpInfo(id, objectCatalogMetadata);
     ...
     */
    public ApiResponse<ObjectCatalogMetadata> updateCatalogMetadataWithHttpInfo(Long id, ObjectCatalogMetadata objectCatalogMetadata) throws ApiException {
        okhttp3.Call localVarCall = updateCatalogMetadataValidateBeforeCall(id, objectCatalogMetadata, null);
        Type localVarReturnType = new TypeToken<ObjectCatalogMetadata>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update an existing catalog-metadata (asynchronously)
     * Update an existing catalog-metadata.&lt;/br&gt; To use this API you must be authenticated.
     * @param id INGV catalog-metadata id that need to be updated. (required)
     * @param objectCatalogMetadata JSON to update (required)
     ...
     */
    public okhttp3.Call updateCatalogMetadataAsync(Long id, ObjectCatalogMetadata objectCatalogMetadata, final ApiCallback<ObjectCatalogMetadata> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateCatalogMetadataValidateBeforeCall(id, objectCatalogMetadata, _callback);
        Type localVarReturnType = new TypeToken<ObjectCatalogMetadata>(){}.getType();
