...
public class AddFocalmechanismRequestData {
  ...
  **/
  ...
  public AddFocalmechanismRequestData addFocalmechanismsItem(ObjectFocalmechanism focalmechanismsItem) {
  ...
  **/
   ...
   * @return the AddFocalmechanismRequestData instance itself
   */
  public AddFocalmechanismRequestData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddFocalmechanismRequestData addFocalmechanismRequestData = (AddFocalmechanismRequestData) o;
    return Objects.equals(this.originid, addFocalmechanismRequestData.originid) &&
        Objects.equals(this.focalmechanisms, addFocalmechanismRequestData.focalmechanisms)&&
        Objects.equals(this.additionalProperties, addFocalmechanismRequestData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(originid, focalmechanisms, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddFocalmechanismRequestData {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddFocalmechanismRequestData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddFocalmechanismRequestData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddFocalmechanismRequestData is not found in the empty JSON string", AddFocalmechanismRequestData.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddFocalmechanismRequestData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddFocalmechanismRequestData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddFocalmechanismRequestData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddFocalmechanismRequestData.class));

       return (TypeAdapter<T>) new TypeAdapter<AddFocalmechanismRequestData>() {
           @Override
           public void write(JsonWriter out, AddFocalmechanismRequestData value) throws IOException {
           ...
           @Override
           public AddFocalmechanismRequestData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddFocalmechanismRequestData instance = thisAdapter.fromJsonTree(jsonObj);
