...
public class AddStrongmotionRequestData {
  ...
  **/
   ...
   * @return the AddStrongmotionRequestData instance itself
   */
  public AddStrongmotionRequestData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eventid, addStrongmotionRequestData.eventid) &&
        ...
        Objects.equals(this.additionalProperties, addStrongmotionRequestData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventid, strongmotions, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddStrongmotionRequestData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AddStrongmotionRequestData>() {
           ...
           public AddStrongmotionRequestData read(JsonReader in) throws IOException {
             ...
             AddStrongmotionRequestData instance = thisAdapter.fromJsonTree(jsonObj);
