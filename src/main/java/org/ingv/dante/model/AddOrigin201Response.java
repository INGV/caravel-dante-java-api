...
public class AddOrigin201Response {
  ...
  public AddOrigin201Response data(@javax.annotation.Nullable AddOrigin201ResponseData data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable AddOrigin201ResponseData data) {
    this.data = data;
  }
   ...
   * @return the AddOrigin201Response instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddOrigin201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddOrigin201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        AddOrigin201ResponseData.validateJsonElement(jsonObj.get("data"));
      }
  }
