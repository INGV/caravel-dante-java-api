...
public class AddOriginRequestData {
  ...
  public AddOriginRequestData eventid(@javax.annotation.Nullable Long eventid) {
  ...
  public AddOriginRequestData origins(@javax.annotation.Nullable List<ObjectOrigin> origins) {
