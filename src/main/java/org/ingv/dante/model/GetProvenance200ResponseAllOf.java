...
public class GetProvenance200ResponseAllOf {
  ...
  private List<ObjectTableProvenance> data = new ArrayList<>();
  ...
  **/
   ...
   * @return the GetProvenance200ResponseAllOf instance itself
   */
  public GetProvenance200ResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, getProvenance200ResponseAllOf.data)&&
        Objects.equals(this.additionalProperties, getProvenance200ResponseAllOf.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetProvenance200ResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetProvenance200ResponseAllOf>() {
           ...
           public GetProvenance200ResponseAllOf read(JsonReader in) throws IOException {
             ...
             GetProvenance200ResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
