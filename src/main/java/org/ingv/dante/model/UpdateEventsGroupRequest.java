...
public class UpdateEventsGroupRequest {
  ...
  public UpdateEventsGroupRequest data(@javax.annotation.Nullable UpdateEventsGroupRequestData data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable UpdateEventsGroupRequestData data) {
    this.data = data;
  }
