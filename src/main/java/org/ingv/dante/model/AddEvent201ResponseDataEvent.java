...
public class AddEvent201ResponseDataEvent {
  ...
  public AddEvent201ResponseDataEvent id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public AddEvent201ResponseDataEvent idLocalspace(@javax.annotation.Nullable Long idLocalspace) {
  ...
  public AddEvent201ResponseDataEvent localspace(@javax.annotation.Nullable AddEvent201ResponseDataEventLocalspace localspace) {
  ...
  public AddEvent201ResponseDataEvent origins(@javax.annotation.Nullable List<AddEvent201ResponseDataEventOriginsInner> origins) {
  ...
  public void setOrigins(@javax.annotation.Nullable List<AddEvent201ResponseDataEventOriginsInner> origins) {
    this.origins = origins;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddEvent201ResponseDataEvent addEvent201ResponseDataEvent = (AddEvent201ResponseDataEvent) o;
    return Objects.equals(this.id, addEvent201ResponseDataEvent.id) &&
        Objects.equals(this.idLocalspace, addEvent201ResponseDataEvent.idLocalspace) &&
        Objects.equals(this.localspace, addEvent201ResponseDataEvent.localspace) &&
        Objects.equals(this.origins, addEvent201ResponseDataEvent.origins)&&
        Objects.equals(this.additionalProperties, addEvent201ResponseDataEvent.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddEvent201ResponseDataEvent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddEvent201ResponseDataEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddEvent201ResponseDataEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("origins") != null && !jsonObj.get("origins").isJsonNull()) {
        ...
        if (jsonArrayorigins != null) {
          ...
          for (int i = 0; i < jsonArrayorigins.size(); i++) {
            AddEvent201ResponseDataEventOriginsInner.validateJsonElement(jsonArrayorigins.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddEvent201ResponseDataEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddEvent201ResponseDataEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddEvent201ResponseDataEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddEvent201ResponseDataEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<AddEvent201ResponseDataEvent>() {
           @Override
           ...
           @Override
           public AddEvent201ResponseDataEvent read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AddEvent201ResponseDataEvent instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AddEvent201ResponseDataEvent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddEvent201ResponseDataEvent
   * @throws IOException if the JSON string is invalid with respect to AddEvent201ResponseDataEvent
   */
  public static AddEvent201ResponseDataEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddEvent201ResponseDataEvent.class);
  }

  /**
   * Convert an instance of AddEvent201ResponseDataEvent to an JSON string
   *
   * @return JSON string
   */
