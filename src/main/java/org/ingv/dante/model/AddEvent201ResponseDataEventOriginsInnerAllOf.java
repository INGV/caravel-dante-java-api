...
public class AddEvent201ResponseDataEventOriginsInnerAllOf {
  ...
  **/
   ...
   * @return the AddEvent201ResponseDataEventOriginsInnerAllOf instance itself
   */
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddEvent201ResponseDataEventOriginsInnerAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
