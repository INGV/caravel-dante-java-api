...
public class ObjectStrongmotionRsaInner {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ObjectStrongmotionRsaInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ObjectStrongmotionRsaInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ObjectStrongmotionRsaInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ObjectStrongmotionRsaInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ObjectStrongmotionRsaInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ObjectStrongmotionRsaInner>() {
           @Override
