...
public class GetEventsGroup200Response {
  ...
  public GetEventsGroup200Response links(@javax.annotation.Nullable LinksDefinition links) {
    this.links = links;
    return this;
  }
  ...
  public GetEventsGroup200Response meta(@javax.annotation.Nullable MetaDefinition meta) {
    this.meta = meta;
    return this;
  }
  ...
  public GetEventsGroup200Response data(@javax.annotation.Nullable List<ObjectMagnitudesOriginsEventsAndEventsGroup> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable List<ObjectMagnitudesOriginsEventsAndEventsGroup> data) {
    this.data = data;
  }
