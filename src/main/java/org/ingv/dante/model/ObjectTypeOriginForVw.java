...
public class ObjectTypeOriginForVw {
  ...
  public ObjectTypeOriginForVw name(@javax.annotation.Nullable TypeOriginName name) {
    this.name = name;
    return this;
  }
  ...
  public ObjectTypeOriginForVw versionName(@javax.annotation.Nullable String versionName) {
