...
public class ObjectLocalspaceForVwWithDOI {
  ...
  public ObjectLocalspaceForVwWithDOI name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ObjectLocalspaceForVwWithDOI environment(@javax.annotation.Nullable Environment environment) {
  ...
  public ObjectLocalspaceForVwWithDOI doi(@javax.annotation.Nullable String doi) {
    this.doi = doi;
    return this;
  }
