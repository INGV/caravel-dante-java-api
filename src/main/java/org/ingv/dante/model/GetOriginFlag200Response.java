...
public class GetOriginFlag200Response {
  ...
  **/
  ...
  public GetOriginFlag200Response addDataItem(ObjectOriginFlag dataItem) {
    if (this.data == null) {
  ...
  **/
   ...
   * @return the GetOriginFlag200Response instance itself
   */
  public GetOriginFlag200Response putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetOriginFlag200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetOriginFlag200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ObjectOriginFlag.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOriginFlag200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOriginFlag200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetOriginFlag200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetOriginFlag200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetOriginFlag200Response>() {
           @Override
           public void write(JsonWriter out, GetOriginFlag200Response value) throws IOException {
           ...
           @Override
           public GetOriginFlag200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GetOriginFlag200Response instance = thisAdapter.fromJsonTree(jsonObj);
