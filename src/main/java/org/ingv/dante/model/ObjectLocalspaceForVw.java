...
public class ObjectLocalspaceForVw {
  ...
  public ObjectLocalspaceForVw name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ObjectLocalspaceForVw environment(@javax.annotation.Nullable Environment environment) {
