...
public class ObjectMomenttensorPostOutputMomenttensor {
  ...
  public ObjectMomenttensorPostOutputMomenttensor id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public ObjectMomenttensorPostOutputMomenttensor idLocalspace(@javax.annotation.Nullable Long idLocalspace) {
  ...
  public ObjectMomenttensorPostOutputMomenttensor localspace(@javax.annotation.Nullable AddEvent201ResponseDataEventLocalspace localspace) {
   ...
   * @return the ObjectMomenttensorPostOutputMomenttensor instance itself
   */
  public ObjectMomenttensorPostOutputMomenttensor putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, objectMomenttensorPostOutputMomenttensor.id) &&
        ...
        Objects.equals(this.additionalProperties, objectMomenttensorPostOutputMomenttensor.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ObjectMomenttensorPostOutputMomenttensor
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ObjectMomenttensorPostOutputMomenttensor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ObjectMomenttensorPostOutputMomenttensor>() {
           ...
           public ObjectMomenttensorPostOutputMomenttensor read(JsonReader in) throws IOException {
             ...
             ObjectMomenttensorPostOutputMomenttensor instance = thisAdapter.fromJsonTree(jsonObj);
