...
public class AddCatalogRequest {
  ...
  **/
   ...
   * @return the AddCatalogRequest instance itself
   */
  public AddCatalogRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddCatalogRequest addCatalogRequest = (AddCatalogRequest) o;
    return Objects.equals(this.data, addCatalogRequest.data)&&
        Objects.equals(this.additionalProperties, addCatalogRequest.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddCatalogRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddCatalogRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddCatalogRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddCatalogRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddCatalogRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddCatalogRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddCatalogRequest>() {
           @Override
           public void write(JsonWriter out, AddCatalogRequest value) throws IOException {
           ...
           @Override
           public AddCatalogRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddCatalogRequest instance = thisAdapter.fromJsonTree(jsonObj);
