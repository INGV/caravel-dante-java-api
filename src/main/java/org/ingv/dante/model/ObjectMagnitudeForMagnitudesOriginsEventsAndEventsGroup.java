...
public class ObjectMagnitudeForMagnitudesOriginsEventsAndEventsGroup {
  ...
  public ObjectMagnitudeForMagnitudesOriginsEventsAndEventsGroup typeMagnitudeExtended(@javax.annotation.Nullable String typeMagnitudeExtended) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, objectMagnitudeForMagnitudesOriginsEventsAndEventsGroup.id) &&
        ...
        Objects.equals(this.typeMagnitudeExtended, objectMagnitudeForMagnitudesOriginsEventsAndEventsGroup.typeMagnitudeExtended) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, idLocalspace, mag, typeMagnitude, typeMagnitudeExtended, lowerUncertainty, upperUncertainty, quality, magQuality, originid, modified, inserted, localspace, provenance, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    typeMagnitudeExtended: ").append(toIndentedString(typeMagnitudeExtended)).append("\n");
  ...
  static {
    ...
    openapiFields.add("type_magnitude_extended");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("type_magnitude_extended") != null && !jsonObj.get("type_magnitude_extended").isJsonNull()) && !jsonObj.get("type_magnitude_extended").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `type_magnitude_extended` to be a primitive type in the JSON string but got `%s`", jsonObj.get("type_magnitude_extended").toString()));
      }
