...
public class ObjectFocalmechanismPostOutput {
   ...
   * @return the ObjectFocalmechanismPostOutput instance itself
   */
  public ObjectFocalmechanismPostOutput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ObjectFocalmechanismPostOutput objectFocalmechanismPostOutput = (ObjectFocalmechanismPostOutput) o;
    return Objects.equals(this.focalmechanisms, objectFocalmechanismPostOutput.focalmechanisms)&&
        Objects.equals(this.additionalProperties, objectFocalmechanismPostOutput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(focalmechanisms, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ObjectFocalmechanismPostOutput {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ObjectFocalmechanismPostOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ObjectFocalmechanismPostOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ObjectFocalmechanismPostOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ObjectFocalmechanismPostOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ObjectFocalmechanismPostOutput>() {
           @Override
           public void write(JsonWriter out, ObjectFocalmechanismPostOutput value) throws IOException {
