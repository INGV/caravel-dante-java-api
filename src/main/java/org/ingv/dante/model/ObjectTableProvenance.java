...
public class ObjectTableProvenance {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, softwarename, version, model, method, parameters, program, username, hostname, description, priority, modified, inserted, additionalProperties);
  }
