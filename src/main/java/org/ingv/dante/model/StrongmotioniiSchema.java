...
public class StrongmotioniiSchema {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ewMessage, strongmotioniiSchema.ewMessage) &&
        ...
        Objects.equals(this.additionalProperties, strongmotioniiSchema.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("ewMessage") != null && !jsonObj.get("ewMessage").isJsonNull()) {
        StrongmotioniiSchemaEwMessage.validateJsonElement(jsonObj.get("ewMessage"));
      }
      // validate the optional field `ewLogo`
      if (jsonObj.get("ewLogo") != null && !jsonObj.get("ewLogo").isJsonNull()) {
        StrongmotioniiSchemaEwLogo.validateJsonElement(jsonObj.get("ewLogo"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StrongmotioniiSchema>() {
           ...
           public StrongmotioniiSchema read(JsonReader in) throws IOException {
             ...
             StrongmotioniiSchema instance = thisAdapter.fromJsonTree(jsonObj);
